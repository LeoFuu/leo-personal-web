...
export const VoidSpirit: React.FC<VoidSpiritProps> = ({ 
  ...
  return (
    /* 💥 终极修复：骨肉分离！
       外层 div 是静态的，专门负责 CSS 定位。
       导航栏时强制水平居中 (-top-5 left-1/2 -translate-x-1/2)，名片时右上角 (-top-9 right-8)。
    */
    <div 
    ...
    >
      {/* 💥 内层 motion.div 才是飞行的本体。
          因为它没有任何 absolute 的 left/right 属性，Framer Motion 只能测量它的纯像素坐标。
          这就彻底斩断了“起跳瞬间向右闪烁”的物理 Bug！ */}
      <motion.div 
